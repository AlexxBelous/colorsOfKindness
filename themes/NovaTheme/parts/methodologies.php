<section class="methodologies">
	<?php if ( have_rows( 'ui_elements_clouds' ) ) : ?>
		<?php while ( have_rows( 'ui_elements_clouds' ) ) :
			the_row(); ?>

			<?php if ( have_rows( 'clouds_settings' ) ) :
				while ( have_rows( 'clouds_settings' ) ) :
					the_row();
					if ( have_rows( 'clouds_list' ) ) : ?>
						<?php while ( have_rows( 'clouds_list' ) ) :
							the_row();
							...
							<?php if ( $cloud_image ) : ?>
								<div class="cloud-item <?php echo esc_attr( $cloud_data ); ?>">
									<img src="<?php echo esc_url( $cloud_image['url'] ); ?>" alt="<?php echo esc_attr( $cloud_image['alt'] ); ?>"
